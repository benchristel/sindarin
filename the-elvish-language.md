...
Tolkien's _tengwar_ script is instantly recognizable—nothing evokes "elvish" like a snippet of _tengwar_ text. It's easy to understand why the _tengwar_ are popular: You don't have to be a Tolkien buff or a language geek to be struck by their one-two punch of badass beauty.
...
For diphthongs, the scribes used a _tengwa_ to represent the first vowel. A mark (_tehta_ in Quenya) above the _tengwa_ represented the second vowel. However, [.s AE] and [.s OE] were often spelled out in full: [.t &#93;l] [.t hl].

<table class="col-3 columns">
<tr>
<td>
    <ul>
    <li>[.tab AE][.t.letterform &#93;l ]or[.t.letterform  &#93;â]</li>
...
<td>
    <ul>
    <li>[.tab OE][.t.letterform hl ]or[.t.letterform  há]</li>
...
The consonant letters are almost the same as in the Mode of Beleriand, except for [.s C],  [.s CH], [.s G]. In Gondor, the letters [.t a], [.t s], and [.t d]  were used for writing the sounds _ch_ (as in _church_), _j_, and _sh_, which were common in the Westron language. Gondorians thus preferred to use [.t z], [.t c], and [.t x] for Sindarin [.s C], [.s CH], and [.s G], respectively.
...
Possessive pronouns—_my_, _your_, _their_—tell you who owns something. In English, these precede the noun they're modifying, but in Sindarin they follow it: _[.hi my] book_ vs. [.s parf <span class="hi">nín</span>].
...
<tr>
  ...
  <td>[.s nín]</td>
  <td>[.s vín][.note the dictionary form of this word is <span class="s">mín</span>—but in actual use it is always mutated to <span class="s">vín</span>]</td>
</tr>
<tr>
  <td>2<sup>nd</sup> person</td>
  <td colspan="2">[.s lín]</td>
</tr>
<tr>
...
In English, we usually form the plural of a noun by adding _-s_: one _wug_, two _wugs_. A few nouns use some kind of vowel mutation instead: one _man_, two _men_, one _goose_, two _geese_.

In Sindarin, this kind of vowel mutation is the normal way of forming plurals. Fortunately, it's quite regular and predictable once you learn the rules.

Each vowel changes in a different way depending on whether it's in the final syllable of a word or not. The changes are shown in the table below. Note that there's no row for [.s I] as it never mutates.
...
The long vowels [.s Ê] and [.s Ô] remained long when mutated: [.s têw] "sign" becomes [.s tîw] in the plural.

How [.s Û] behaved is uncertain, since we have only a single example: [.s Emyn Duir] "dark mountains" as the plural of [.s Amon Dûr][.note _Unfinished Tales_ p. 280]—the adjective [.s dûr] "dark" is affected by the same plural mutation as the noun it modifies. We might tentatively conclude from this that [.s Û] always becomes [.s UI] in the plural.

### Irregular Vowel Mutations
