...
Tolkien did not, of course, develop Sindarin in a vacuum[^vacuum]. He was greatly inspired by the Welsh language, which he encountered in his childhood and later studied. When he was in his early twenties, he created the language Gnomish or _Goldogrin_, inspired by Welsh. In Goldogrin we can see the predecessors of many Elvish words and grammatical patterns—even the name of the language bears the _-rin_ suffix later applied to _Sindarin_, _Noldorin_, _Telerin_, etc. Indeed, several Goldogrin words appear essentially unchanged in Sindarin: we have Goldogrin _gloss_ "white", often mutated to _'loss_ after another element



[^vacuum]: Philologists do not work well in vacuums as a general rule; the environment impedes the functioning of their lungs. Also, in a vacuum, no one can hear you pronounce /ɬ/.
